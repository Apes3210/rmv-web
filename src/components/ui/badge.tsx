  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors shadow-[inset_0_1px_0_rgba(255,255,255,0.55)]',
  {
    variants: {
      variant: {
        ...
        secondary: 'border-[#c6ccd4] bg-[linear-gradient(180deg,#eff2f5_0%,#d9dee5_100%)] text-secondary-foreground dark:border-slate-500 dark:bg-none dark:bg-slate-700/85 dark:text-slate-100',
